...
public class Assignment2_Arrays {
	...
	public static void main(String[] args) {
		/**
		 * This class contains the functions of 3D array description : A supermarket
		 * offers products in two main categories: "Groceries" and "Electronics." Each
		 * category is further divided into four sub categories, with each sub category
		...
		// Initializing 3 d array to allocate memory for 2 main category, 4 sub category
		// and 5 products
